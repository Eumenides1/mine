<template>
  <div class="well_right">
    ...
    <span @click="changeText" class="phone-sapn">生日：{{ textToChange }}</span>
  </div>
  <div class="demo-color-block">
    <span class="demonstration">喜欢的颜色：</span>
...
export default {
  data() {
    return {
      // 初始化要改变的文本
      textToChange: '2002-1-3'
    }
  },
  methods: {
    // 添加一个方法来改变文本
    changeText() {
      this.textToChange = prompt('请输入新的文本', this.textToChange)
    }
  }
}
</script>
